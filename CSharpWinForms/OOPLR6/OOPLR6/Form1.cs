...
namespace OOPLR2
{
    public partial class Form1 : Form
    {
        ...
        private void OnJ1Create(object sender, EventArgs e)
        {
            ...
            j1incrBtn.Enabled = true;
            if (mag2 is not null) equalsBtn.Enabled = true;
        }
        ...
        private void OnJ2Create(object sender, EventArgs e)
        {
            ...
            if (mag1 is not null) equalsBtn.Enabled = true;
        }
        ...
        private void OnJ1Incr(object sender, EventArgs e)
        {
            mag1?.Info();
            (mag1++).Info();
            (++mag1).Info();
        ...
        private void OnCompareJ12(object sender, EventArgs e)
        {
            mag1?.Info();
            mag2?.Info();
            MessageBox.Show(mag1 == mag2 ? "Це один і то й же журнал!" : "Це різні журнали.", "Оператор ==");
        }
    }
    ...
    public class JuniorMagazine : Magazine
    {
        ...
        public static JuniorMagazine operator ++(JuniorMagazine o)
        {
            ++o.Issue;
            return o;
        }
        public static JuniorMagazine operator --(JuniorMagazine o)
        {
            if (o.Issue > 0) --o.Issue;
            return o;
        }
        public static bool operator ==(JuniorMagazine l, JuniorMagazine r)
        {
            return l.Issue == r.Issue && l.PeriodInDays == r.PeriodInDays && l.NumberOfPages == r.NumberOfPages
                && l.AvgWordsPerPage == r.AvgWordsPerPage && l.NofImages == r.NofImages && l.NofAds == r.NofAds
                && l.NofActivities == r.NofActivities && l.Title == r.Title && l.Author == r.Author;
        }
        public static bool operator !=(JuniorMagazine l, JuniorMagazine r) => !(l == r);
