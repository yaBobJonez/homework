...
namespace BD_Lab6
{
    public partial class FormPlanes : Form
    {
        ...
        {
            this.planeTableAdapter.Update(this.flightsDBDataSet.Plane);
        }
        ...
        private void sortBtn_Click(object sender, EventArgs e)
        {
            ...
            string q = $"SELECT {limit} * FROM Plane ORDER BY {column} {order}";
        ...
        private void betweenBtn_Click(object sender, EventArgs e)
        {
            ...
            string q = $"SELECT * FROM Plane WHERE {column} BETWEEN '{from}' AND '{to}'";
            this.dataGridView1.DataSource = DBConnector.QuerySelect(q);
            this.dataGridView1.ReadOnly = true;
        }
        ...
        private void groupBtn_Click(object sender, EventArgs e)
        {
            ...
            string q = $"SELECT {group} AS group_name, {action}({actionField}) AS result FROM Plane WHERE " +
