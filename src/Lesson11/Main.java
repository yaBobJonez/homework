...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int a2 = Integer.parseInt(pointA[0]);
        int b2 = Integer.parseInt(pointA[1]);
        ...
        int x2 = Integer.parseInt(pointA[0]);
        int y2 = Integer.parseInt(pointA[1]);
        boolean doPointsOverlap = false;
        if(pointsOverlap(a1, b1, x1, y1) || pointsOverlap(a2, b2, x2, y2) || pointsOverlap(a2, b1, x2, y1) || pointsOverlap(a1, b2, x1, y2)){
            System.out.println("Точки при вершинах совпадают.");
        } else if(sidesOverlap(x1, a2) || sidesOverlap(a1, x2) || sidesOverlap(y2, b1) || sidesOverlap(b2, y1)){
            System.out.println("Стороны прямоугольников совпадают.");
            ...
            System.out.println("Прямоугольник А налегает на прямоугольник Б.");
            ...
            System.out.println("Прямоугольник Б налегает на прямоугольник А.");
        } else System.out.println("Прямоугольники не взаимодействуют друг с другом.");
    }
    public static boolean pointsOverlap(int x, int y, int a, int b){
        return x == a && y == b;
    }
