...
public class Main {
    public static void main(String[] args) throws Exception {
        File f = new File("./Exceptions/src/Exceptions4/File1.txt");
        ...
        divide(x, y);
        display(z);
        File f2 = new File("./Exceptions/src/Exceptions4/File3.txt");
        create(f2);
        File f3 = new File("./Exceptions/src/Exceptions4/File4.txt");
        try { createFile(f3); }
    ...
    private static void display(int[] arr){
        ...
        finally { System.err.println("Resource leak prevented."); }
    }
